...
const testCard = { competitionName: 'Aaa', rinkNumber: 11, date: new Date(), 
    teamA: {name: 'US', player1: { name: 'Eugene',}, player2: { name: 'Warren',}, player3: { name: 'Bill',}, player4: { name: 'Will',}, }, 
    teamB: {name: 'China', player1: { name: 'Buffet',}, player2: { name: 'Gates',}, player3: { name: 'Smith',}, player4: { name: 'John',},} }
